...
public class DocumentFolder {
	...
	public DocumentFolder(int document_folder_num, String mainProject_projectNum, String document_folder_title) {
		super();
	...
	public String toString() {
		return "DocumentFolder [document_folder_num=" + document_folder_num + ", mainProject_projectNum="
				+ mainProject_projectNum + ", document_folder_title=" + document_folder_title + "]";
	}
