	    ...
	    function layer_popup(el, pc){
	        ...
	        if (pc == null) {
		        ...
		        $el.find('a#update').click(function(){
		        	...
		        	//완료버튼 생성
		        	$('div.btn-r').html('<input type="button" style="height:40px;margin-right:5px" class="btn btn-dark btn-layerClose" id="updateContent" onclick="doUpdateSubmit()" value="완료" />'
		        		+'<a href="#" style="height:40px;margin-right:5px" class="btn btn-danger btn-layerClose" id="close">닫기</a>');
		            return false;
				});
			}
