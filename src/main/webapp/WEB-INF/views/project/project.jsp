...
<div class="wrapper">
    <div class="sideSpace">
        <div class="sideSpace_top">
            <img class="webLogo" src="img/sprout_logo.png">
        </div>
        <div class="sideSpace_bottom">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#home">멤버</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#menu1">메세지</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#menu2">공지사항</a>
                </li>
            </ul>
                    ...
                    <div class="dropdown dropleft float-right h-100">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div style="margin-top:20px ">
                                <a href="#" class="list-group-item list-group-item-action border-left-0 border-right-0">회원정보</a>
                                <a href="#" class="list-group-item list-group-item-action border-left-0 border-right-0">로그아웃</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mainSpace_bottom">
            ...
            <div class="contentSpace_right">
                <div class="contentItem" style="margin:20px;height:100%;">
                    <div class="dropdown dropleft float-right h-100">
                        <button type="button" class="btn btn-dark h-100" data-toggle="dropdown"><i class="fas fa-chevron-left fa-lg"></i></button>
                        <div class="dropdown-menu h-100" style="width:500px;min-width: 300px">
                            <div id="headers"></div>
                        </div>
                    </div>
                </div>
